...
def main() -> None:
    ...
    figures = [
        ...
        },
        {
            ...
            "cap": "Collapsed to the four major classes: immune and endothelial self-associate strongly, and the tumor↔immune block is strongly negative — immune exclusion.",
        },
        {
        ...
        },
        {
            "file": "km_niche7.png",
            "tab": "surv",
            "title": "Kaplan-Meier — niche 7 (tumor-rich, immune-poor)",
